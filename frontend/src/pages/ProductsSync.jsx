    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-5">
        <div className="bg-white rounded-xl border border-gray-200/80 shadow-sm p-4">
          <p className="text-[11px] uppercase tracking-wider text-gray-500 font-medium">Total Products</p>
        ...
        <div className="bg-white rounded-xl border border-gray-200/80 shadow-sm p-4">
          <p className="text-[11px] uppercase tracking-wider text-gray-500 font-medium">ERP Mapped</p>
          <p className="text-xl font-bold text-emerald-600 mt-0.5">{mapped}</p>
        </div>
        <div className="bg-white rounded-xl border border-gray-200/80 shadow-sm p-4">
          <p className="text-[11px] uppercase tracking-wider text-gray-500 font-medium">Unmapped</p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 text-left">
                ...
                <th className="px-4 py-3 font-medium text-gray-600 text-center">Weight</th>
                <th className="px-4 py-3 font-medium text-gray-600 text-center">Stock</th>
                <th className="px-4 py-3 font-medium text-gray-600">Status</th>
                <th className="px-4 py-3 font-medium text-gray-600">ERP Mapped</th>
            ...
            <tbody>
              {filtered.map((p, i) => (
                <tr key={p.shopifyId} className={`border-t border-gray-100 ${i % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'}`}>
                  <td className="px-4 py-2.5">
                    <p className="font-medium text-royal-950">{p.title}</p>
                  ...
                  <td className="px-4 py-2.5 text-center text-gray-600">{p.weight}</td>
                  <td className="px-4 py-2.5 text-center font-mono text-gray-600">{p.stock}</td>
                  ...
                  <td className="px-4 py-2.5 text-xs text-gray-500">{p.lastSync || 'Never'}</td>
              ...
              {filtered.length === 0 && (
                <tr>
                  <td colSpan="9" className="px-4 py-8 text-center text-sm text-gray-400">No products found</td>
                </tr>
              )}
            </tbody>
          </table>
