  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-5">
        ...
        <div className="bg-white rounded-xl border border-gray-200/80 shadow-sm p-4">
          <div className="flex items-center justify-between">
            <p className="text-[11px] uppercase tracking-wider text-gray-500 font-medium">Pending Approval</p>
        ...
        <div className="bg-white rounded-xl border border-gray-200/80 shadow-sm p-4">
          <div className="flex items-center justify-between">
            <p className="text-[11px] uppercase tracking-wider text-gray-500 font-medium">Price Mismatches</p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 text-left">
                ...
                <th className="px-4 py-3 font-medium text-gray-600 text-right">ERP Price</th>
                <th className="px-4 py-3 font-medium text-gray-600 text-right">Shopify Price</th>
            ...
            <tbody>
              {items.map((item, i) => {
                ...
                return (
                  <tr key={item.sku} className={`border-t border-gray-100 ${i % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'}`}>
                    ...
                    <td className={`px-4 py-2.5 text-right font-mono ${diff !== 0 ? 'text-red-600 font-semibold' : 'text-gray-400'}`}>
                      {formatINR(diff)}
                    </td>
              ...
              {items.length === 0 && (
                <tr>
                  <td colSpan="8" className="px-4 py-8 text-center text-sm text-gray-400">No products found</td>
                </tr>
              )}
            </tbody>
          </table>
